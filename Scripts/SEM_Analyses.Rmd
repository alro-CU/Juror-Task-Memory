...
anova(fit_c, fit_alt_semantic)

#compared to epsiodic pathway
anova(fit_c, fit_alt_episodic)
```
...
# Compare the semantic and episodic models to just common factor model 

```{r}
#semantic only vs common factor 
anova(fit_alt_semantic, fit_gen)

#episodic only versus common factor
anova(fit_alt_episodic, fit_gen)
